...
export declare enum GatewayCommand {
    ...
    GW_GET_SCENE_INFOAMATION_REQ = 1039,
    GW_GET_SCENE_INFOAMATION_CFM = 1040,
    GW_GET_SCENE_INFOAMATION_NTF = 1041,
