...
describe("KLF200-API", function() {
    describe("GW_GET_LIMITATION_STATUS_REQ", function() {
        ...
        it("should write the correct default values", function() {
            ...
            expect(buff.readUInt8(27)).to.be.equal(LimitationType.MaximumLimitation, "LimitationType wrong.");
            expect(buff.readUInt8(26)).to.be.equal(0, "ParameterID wrong.");
        });
        ...
        it("should write the single node", function() {
            ...
            expect(buff.readUInt8(6)).to.be.equal(42, "Node array wrong.");
        });
        ...
        it("should write multiple nodes", function() {
            ...
            expect(buff.readUInt8(6)).to.be.equal(42, "Node array byte 1 wrong.");
            expect(buff.readUInt8(7)).to.be.equal(87, "Node array byte 2 wrong.");
        });
