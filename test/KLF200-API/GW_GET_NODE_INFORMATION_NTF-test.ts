...
import 'mocha';
import { GW_GET_NODE_INFORMATION_NTF, Velocity, NodeVariation, ActuatorType, PowerSaveMode, NodeOperatingState, ActuatorAlias } from "../../src";

describe("KLF200-API", function() {
    describe("GW_GET_NODE_INFORMATION_NTF", function() {
        describe("Constructor", function() {
            const data = Buffer.from([127, 0x02, 0x10, 
                // Node ID
                1,
                // Order
                0x00, 0x02,
            ...
            it("should create without error", function() {
                expect(() => new GW_GET_NODE_INFORMATION_NTF(data)).not.to.throw();
            });
