...
const simpleRequests: requestListEntryType[] = [
	...
	{
		RequestClass: new GW_CS_GET_SYSTEMTABLE_DATA_REQ(),
		RequestCommand: GatewayCommand.GW_CS_GET_SYSTEMTABLE_DATA_REQ,
	},
	{ RequestClass: new GW_CS_VIRGIN_STATE_REQ(), RequestCommand: GatewayCommand.GW_CS_VIRGIN_STATE_REQ },
	{
		RequestClass: new GW_CS_CONTROLLER_COPY_CANCEL_NTF(),
		RequestCommand: GatewayCommand.GW_CS_CONTROLLER_COPY_CANCEL_NTF,
	},
	...
	{
		RequestClass: new GW_GET_ALL_NODES_INFORMATION_REQ(),
		RequestCommand: GatewayCommand.GW_GET_ALL_NODES_INFORMATION_REQ,
	},
	{
		RequestClass: new GW_HOUSE_STATUS_MONITOR_ENABLE_REQ(),
		RequestCommand: GatewayCommand.GW_HOUSE_STATUS_MONITOR_ENABLE_REQ,
	},
	{
		RequestClass: new GW_HOUSE_STATUS_MONITOR_DISABLE_REQ(),
		RequestCommand: GatewayCommand.GW_HOUSE_STATUS_MONITOR_DISABLE_REQ,
	},
	{ RequestClass: new GW_INITIALIZE_SCENE_REQ(), RequestCommand: GatewayCommand.GW_INITIALIZE_SCENE_REQ },
	{
		RequestClass: new GW_INITIALIZE_SCENE_CANCEL_REQ(),
		RequestCommand: GatewayCommand.GW_INITIALIZE_SCENE_CANCEL_REQ,
	},
	{ RequestClass: new GW_GET_SCENE_LIST_REQ(), RequestCommand: GatewayCommand.GW_GET_SCENE_LIST_REQ },
	{
		RequestClass: new GW_GET_CONTACT_INPUT_LINK_LIST_REQ(),
		RequestCommand: GatewayCommand.GW_GET_CONTACT_INPUT_LINK_LIST_REQ,
	},
	{
		RequestClass: new GW_GET_ACTIVATION_LOG_HEADER_REQ(),
		RequestCommand: GatewayCommand.GW_GET_ACTIVATION_LOG_HEADER_REQ,
	},
