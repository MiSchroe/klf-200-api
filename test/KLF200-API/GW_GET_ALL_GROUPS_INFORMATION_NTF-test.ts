...
import 'mocha';
import { GW_GET_ALL_GROUPS_INFORMATION_NTF, Velocity, NodeVariation, GroupType } from "../../src";

describe("KLF200-API", function() {
    describe("GW_GET_ALL_GROUPS_INFORMATION_NTF", function() {
        describe("Constructor", function() {
            const data = Buffer.from([102, 0x02, 0x2B, 
                // Group ID
                1,
                // Order
                0x00, 0x02,
