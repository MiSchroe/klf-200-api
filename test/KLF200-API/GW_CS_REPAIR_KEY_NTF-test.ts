...
import { GW_CS_REPAIR_KEY_NTF } from "../../src";

describe("KLF200-API", function () {
	describe("GW_CS_REPAIR_KEY_NTF", function () {
		describe("Constructor", function () {
			it("should create without error", function () {
				...
				assert.doesNotThrow(() => new GW_CS_REPAIR_KEY_NTF(data));
			});
			...
			it("should return the ChangeKeyStatus", function () {
				...
				const result = new GW_CS_REPAIR_KEY_NTF(data);
