...
describe("products", function() {
    ...
    describe("Products class", function () {
        ...
        const receivedFramesEmptyProductsList = [
            dataAllNodesCfmEmptyProductsList
        ];
            ...
            describe("onNotificationHandler", function() {
                ...
                describe("GW_NODE_INFORMATION_CHANGED_NTF", function() {
                    it("should send notifications for Name, NodeVariation, Order and Placement", function() {
                        ...
                        expect(propertyChangedSpy, "Name").to.be.calledWithMatch({o: product, propertyName: "Name", propertyValue: "Dummy"});
                        expect(propertyChangedSpy, "NodeVariation").to.be.calledWithMatch({o: product, propertyName: "NodeVariation", propertyValue: NodeVariation.Kip});
                        expect(propertyChangedSpy, "Order").to.be.calledWithMatch({o: product, propertyName: "Order", propertyValue: 2});
                        expect(propertyChangedSpy, "Placement").to.be.calledWithMatch({o: product, propertyName: "Placement", propertyValue: 3});
                    });
                    ...
                    it("should send notifications for Name only", function() {
                        ...
                        expect(propertyChangedSpy, "Name").to.be.calledOnceWith(sinon.match({o: product, propertyName: "Name", propertyValue: "Dummy"}));
                    });
                ...
                describe("GW_NODE_STATE_POSITION_CHANGED_NTF", function() {
                    it("should send notifications for State, CurrentPositionRaw, CurrentPosition, TargetPositionRaw, TargetPosition, FP1CurrentPositionRaw, FP2CurrentPositionRaw, FP3CurrentPositionRaw, FP4CurrentPositionRaw, RemainingTime, TimeStamp", function() {
                        ...
                        expect(propertyChangedSpy, "State").to.be.calledWithMatch({o: product, propertyName: "State", propertyValue: NodeOperatingState.Executing});
                        ...
                        expect(propertyChangedSpy, "TargetPositionRaw").to.be.calledWithMatch({o: product, propertyName: "TargetPositionRaw", propertyValue: 0xC700});
                        expect(propertyChangedSpy, "TargetPosition").to.be.calledWithMatch({o: product, propertyName: "TargetPosition", propertyValue: 0.0050000000000000044});
                        expect(propertyChangedSpy, "FP1CurrentPositionRaw").to.be.calledWithMatch({o: product, propertyName: "FP1CurrentPositionRaw", propertyValue: 0xF7FE});
                        expect(propertyChangedSpy, "FP2CurrentPositionRaw").to.be.calledWithMatch({o: product, propertyName: "FP2CurrentPositionRaw", propertyValue: 0xF7FE});
