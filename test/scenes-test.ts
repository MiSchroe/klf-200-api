...
describe("scenes", function() {
    ...
    describe("Scenes class", function () {
        ...
        const dataScenesListNtf1 = Buffer.from([135, 0x04, 0x0E,
            // Number of scenes
            2,
            // Scene 1
            //   ID
        ...
        const dataScenesListNtf2 = Buffer.from([135, 0x04, 0x0E,
            // Number of scenes
            2,
            // Scene 3
            //   ID
            2,
            //   Name
            0x44, 0x75, 0x6D, 0x6D, 0x79, 0x20, 0x33, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            ...
            3,
            //   Name
            0x44, 0x75, 0x6D, 0x6D, 0x79, 0x20, 0x34, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        ...
        const dataScene2Details = Buffer.from([78, 
            // Command
            0x04, 0x11,
            // Scene 2
            //   ID
        ...
        const dataScene3Details = Buffer.from([78, 
            // Command
            0x04, 0x11,
            // Scene 3
            //   ID
        ...
        const dataScene4Details = Buffer.from([78, 
            // Command
            0x04, 0x11,
            // Scene 4
            //   ID
        ...
        describe("Scene class", function() {
            ...
            describe("refreshAsync", function() {
                ...
                it("should throw an error on request rejected.", async function() {
                    const conn = new MockConnection([...receivedFrames, new GW_GET_SCENE_INFORMATION_CFM(dataScene3DetailsInvalidCfm)]);
                    const sc = await Scenes.createScenesAsync(conn);
                    const scene = sc.Scenes[2];
                    const propertyChangedEventSpy = sinon.spy();
                    scene.propertyChangedEvent.on((scene) => {
